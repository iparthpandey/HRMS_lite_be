    ...
    useEffect(() => {
        async function loadData() {
            try {
                ...
                const monthlyRes = await fetch('http://localhost:8000/attendance/monthly');
                const weeklyRes = await fetch('http://localhost:8000/attendance/weekly-trend');

                setEmployees(empData);
                setDepartments(deptData);
                setMonthlyAttendance(await monthlyRes.json());
